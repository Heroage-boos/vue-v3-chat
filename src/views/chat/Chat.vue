<template>
    <div class="wrapper">
        <div class="container boder">
            ...
            <div class="right">
                <div class="top"><span>To: <span class="name">Chat GTP</span></span></div>
                <div class="chat" data-chat="person1">
                    <div class="conversation-start">
                        <span>Today, 6:48 AM</span>
                    </div>
                    <div class="bubble you" :key="index" v-for="a, index in content"
                        :class="{ 'me': a.send_id == 'me', 'you': a.send_id == 'you' }">
                        <!-- v-html="a.task_info " -->
                        <div class="flex" v-if="a.send_id == 'me'">
                            <div class="">
                        ...
                        <div class="flex-end" v-if="a.send_id == 'you'">
                ...
                <div class="write">
                    ...
                    <input type="text" v-on:keyup="inputEnterUp($event)" placeholder="Enter" v-model="send_info" />
                    <div href="javascript:;" class="write-link smiley"></div>
                    <div class="write-link send" v-on:click="handlerSend()"></div>
                </div>
            </div>
        </div>
    </div>
...
export default defineComponent({
    ...
    methods: {
        ...
        inputEnterUp(d: KeyboardEvent) {
            d.key === 'Enter' ? this.handlerSend() : ''
            console.log("d", d);
        },

        handlerSend() {
            let sendContent = this.send_info
