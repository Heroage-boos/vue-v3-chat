      ...
      <div class="container">
        ...
        <section class="home-cards">
          <div>
            ...
            <p>
              See how Katie Sowers, Asst. Coach for the 49ers, uses Surface Pro 7 to put her plans
              into play.
            </p>
          ...
          <div>
            ...
            <p>
              Buy an Xbox One X console and double your fun with a free select extra controller.
              Starting at $349.
            </p>
            <a href="#">Learn More <i class="fas fa-chevron-right"></i></a>
          </div>
          <div>
            ...
            <p>
              Expect more. World class performance, with more privacy, more productivity, and more
              value.
            </p>
            <a href="#">Learn More <i class="fas fa-chevron-right"></i></a>
          </div>
        ...
        <section class="xbox">
          <div class="content">
            ...
            <p>
              Xbox Game Pass Ultimate Xbox Live Gold and over 100 high-quality console and PC games.
...
import HeaderSilder from './HeaderSilder.vue'
